...
public class Transaction {
	...
	public final void setPayee(String payee) { this.payee.set(payee); }

	public final StringProperty getPayeeProperty() { return payee; }
	...
	public final void setInflow(BigInteger inflow) { this.inflow.set(inflow); }
